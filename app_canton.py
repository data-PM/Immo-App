...
if 'liste_communes' not in st.session_state:
    st.session_state.dict_communes = pickle.load(open('./App/liste_communes.p', 'rb'))
...
if commune == '':
    ...
    canton = st.session_state.dict_communes[commune]

    communes = pickle.load(open('App/cantons/' + canton + '.p', 'rb'))
